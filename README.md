...
- 当前系统架构、契约和质量边界：[docs/system/README.md](docs/system/README.md)
- 当前维护上下文与后续候选：[docs/project/current.md](docs/project/current.md)
- 完整文档导航：[docs/README.md](docs/README.md)
- Claude Code 执行合同：[SKILL.md](SKILL.md)
