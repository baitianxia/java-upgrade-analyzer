...
CHANGE_TYPES = {
    ...
    "CONTRACT_CHANGED":  "方法签名未变，但注解、修饰符或其他 API 契约发生变化",
    "METHOD_ADDED":      "新增方法；现有调用方不受二进制链接影响",
    "MEMBER_RESOLUTION_CHANGED": "相同符号引用在升级后解析到不同的定义成员",
